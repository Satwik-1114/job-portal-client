...
const Recruiter = () => {
    const {
        ...
        queryFn: async () => {
            const response = await axios.get(
                `https://job-portal-server-kappa-bice.vercel.app/api/v1/application/recruiter-jobs`,
                {
    ...
    const handleAcceptStatus = (id, recruiterId) => {
        ...
        updateJobStatusMutation.mutate({
            body: newStatus,
            url: `https://job-portal-server-kappa-bice.vercel.app/api/v1/application/${id}`,
        });
    };
